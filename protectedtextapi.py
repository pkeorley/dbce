...
class ProtectedTextApi:
    ...
    def save(self, textToSave):
        ...
        postdata["currentHashContent"] = self.getWritePermissionProof(textToSave)
        postdata["encryptedContent"] = textEncrypted
    ...
    def deleteSite(self):
        ...
        deleteAction = {}
        deleteAction["initHashContent"] = inithashcontent
